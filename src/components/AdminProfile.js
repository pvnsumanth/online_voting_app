...
//   useEffect(() => {
//     if (id) {
//       fetch(`https://online-voting-app-backend.onrender.com/AdminsRoute/get-admin/${id}`)
...
//         {/* <div style={{ backgroundColor: "#ffd9b3",height:"30vh" }}></div> */}
//       <div>
//         <div className="text-center" style={{marginTop:"-15vh"}}>
//               <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="admin-pic" style={{ borderRadius: "50%", height: "30vh" }} />
//         </div>
//       </div>
...
//               <p style={{paddingLeft:"0.8vh",fontFamily:"serif",fontWeight:"bolder",fontSize:"3vh"}} className="mt-3">User Name</p>
//               <div style={{ border: "1px solid #D0D0D0",borderRadius:"7px",backgroundColor:"#D0D0D0	" }}>
//                 <p style={{padding:"1vh 0vh 0vh 1vh",fontFamily:"serif",fontSize:"2.5vh"}}>{userData.username}</p>
//               </div>

//               <p style={{paddingLeft:"0.8vh",fontFamily:"serif",fontWeight:"bolder",fontSize:"3vh"}} className="mt-3">Phone Number</p>
//               <div style={{ border: "1px solid #D0D0D0",borderRadius:"7px",backgroundColor:"#D0D0D0	" }}>
//                 <p style={{padding:"1vh 0vh 0vh 1vh",fontFamily:"serif",fontSize:"2.5vh"}}>{userData.phoneNumber}</p>
//               </div>

//               <p style={{paddingLeft:"0.8vh",fontFamily:"serif",fontWeight:"bolder",fontSize:"3vh"}} className="mt-3">Email</p>
//               <div style={{ border: "1px solid #D0D0D0",borderRadius:"7px",backgroundColor:"#D0D0D0	" }}>
//                 <p style={{padding:"1vh 0vh 0vh 1vh",fontFamily:"serif",fontSize:"2.5vh"}}>{userData.email}</p>
//               </div>
...
//                 <p style={{padding:"1vh 0vh 0vh 1vh",fontFamily:"serif",fontSize:"2.5vh"}} >{userData.address}</p>
//               </div>
//               <div className="text-center"><Link to={"/Admin/EditAdmin/"+id} ><button className="btn mb-5" style={{backgroundColor:"rgb(43,24,155)",color:"White"}}>Edit Data</button></Link></div>
//           </div>
