...
export default function Results() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response1 = await axios.get("https://online-voting-app-backend.onrender.com/PartiesRoute");
        ...
        const response2 = await axios.get("https://online-voting-app-backend.onrender.com/IsVotedRoute");
