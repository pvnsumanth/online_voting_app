...
function AdminHome() {
  ...
  useEffect(() => {
    // Fetch voters count
    axios.get("https://online-voting-app-backend.onrender.com/VoterListRoute/Voters-count")
      .then((response) => {
    ...
    axios.get("https://online-voting-app-backend.onrender.com/IsVotedRoute/Isvoted-count")
      .then((response) => {
        const count = response.data.count;
    ...
    // Fetch parties count
    axios.get("https://online-voting-app-backend.onrender.com/PartiesRoute/Parties-count")
      .then((response) => {
        const count = response.data.count;
